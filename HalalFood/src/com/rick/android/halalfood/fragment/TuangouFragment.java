...
public class TuangouFragment extends BaseFragment implements OnClickListener {

    private static TuangouFragment instance;

    public static final TuangouFragment getInstance() {
        if (null == instance) {
            instance = new TuangouFragment();
        }
        return instance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tuangou, container, false);
