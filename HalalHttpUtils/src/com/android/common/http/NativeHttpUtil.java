...
public class NativeHttpUtil {
    ...
    public static String get(String url, Map<String, String> params) {
        InputStream is = null;
        try {
            String queryString = ApiUtil.getUrlEncodedQueryString(params);
            if (queryString != null) {
                url = url + "?" + queryString;
            }
            URL u = new URL(url);
    ...
    /**
     * @param url 请求链接
     * @param params HTTP POST请求body的封装map集合
     * @return
     */
    public static String post(String url, Map<String, String> params) {
        ...
        InputStream is = null;
        String body = ApiUtil.getUrlEncodedQueryString(params);
    ...
    /**
     * @param url 请求链接
     * @param params HTTP POST请求文本参数map集合
     * @param files HTTP POST请求文件参数map集合
